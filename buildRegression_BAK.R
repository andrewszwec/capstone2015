...
save(mod_rf_full, file = "rf_regression_001.RData")
...
################################################################################
## Model to predict the likelihood of a 5 star review 
################################################################################
...
pred <- data.frame(rf_full_predictions, stars=testing$stars)
